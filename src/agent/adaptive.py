...
BANK_PATH = pathlib.Path(__file__).resolve().parent.parent.parent / "data" / "item_bank.json"
_LISTENING_SCRIPTS = pathlib.Path(__file__).resolve().parent.parent.parent / "data" / "listening_scripts.json"
